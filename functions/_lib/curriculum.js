...
const CA_WARNINGS_SHARED = [
  ...
  { rule: "The vendor name has to match exactly", detail: "On the training request the company is Resilient Leadership Solutions — the full name as it appears in your portal, not the RLS abbreviation. A quote in a different name is the most common bounce." },
